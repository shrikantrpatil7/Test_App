        ...
        <div className="row align-items-center">
          <div className="col-lg-8">
            <div className="img main-img2">
              ...
              <img src="/assets/img/about/Financial.PNG" alt="" className="img-body" />
            </div>
          </div>
          <div className="col-lg-4 smsm">
            <div className="section-head mb-30 style-5">
              <h2>{ rtl ? 'أكثر من 100' : '100+ Payment' } <span>{ rtl ? 'بوابة دفع' : 'Gateways' }</span> </h2>
            </div>
            <p>
              { rtl ? 'مع سوق Iteck ، اختر من بين مئات بوابات الدفع لعملائك. من PayPal إلى Stripe إلى Skrill ، Visa Debit ، Master Card ، إلخ' : 'Join the community of AeronPay, We facilitate our customers with Instant and Secure transactions. If its about security, no worry...!' }
            </p>
