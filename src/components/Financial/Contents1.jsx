        ...
        <div className="row align-items-center">
          <div className="col-lg-4 order-2 order-lg-0">
            <div className="section-head mb-30 style-5">
              <h2>{ rtl ? 'تجارب المستخدم ' : 'Slick Financial' } <span>{ rtl ? 'المحسّنة' : 'Experiences' }</span> </h2>
            </div>
            <p>{ rtl ? 'يمكن تبسيط عمليات التحميل والتحديث التي يقوم بها الموردون من خلال لوحات المعلومات الأمامية التي توفر سهولة الوصول بشكل أفضل.' : 'Buy and Sell Digital Gold & Digital Silver Anytime, Anywhere from AeronPay. Start cashless life in just one tap. Make Bharat Online !' }</p>
