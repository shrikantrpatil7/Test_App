          ...
          <div className="col-lg-5 order-2 order-lg-0">
            <div className="info">
              <div className="section-head style-4">
                <small className="title_small">{ rtl ? 'إدارة أفضل للملاحظات' : 'Better Payment Management' }</small>
                <h2 className="mb-30">{ rtl ? 'ملاحظاتك' : 'What Make Us' } <span> { rtl ? 'في امان' : 'Unique' } </span></h2>
              </div>
              <p className="text mb-40">
                {
                 ...
                 :
                 'Effortlessly accept payments by scanning BHIM UPI QR codes, simplifying transactions for your fintech business.' 
                }
              </p>
