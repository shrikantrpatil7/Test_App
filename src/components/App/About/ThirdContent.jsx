          ...
          <div className="col-lg-5">
            <div className="info">
              <div className="section-head style-4">
                <small className="title_small">{ rtl ? 'ثيمات جميلة' : 'Sleek Designs for Fintech Platforms' }</small>
                <h2 className="mb-30">{ rtl ? 'ركز أكثر مع' : 'Boost Your Offline Business ' } <span>{ rtl ? 'المظهر الداكن' : 'With AeronPay' }</span> </h2>
              </div>
              <p className="text mb-40">
                { rtl ? 'قم بتطبيق سمات نوتيرو الأنيقة حسب ذوقك. تعمل السمات المظلمة بشكل ممتاز لأولئك الذين يفضلون الوضع الخالي من الإلهاء.' : 'AeronPay gives you an excellent opportunity to expand your business by allowing you to take payment with AeronPay QR.' }
              </p>
              <ul>
                {
